/***
 *@Author       : xyoung
 *@Date         : 2023-11-16 13:41:18
 *@LastEditTime : 2023-11-16 13:42:46
 */
...
public:
	...
	void showTime();
	void saveBin(std::string bin_file);
	bool PreProcess(const cv::Mat &img, int width, int height);
	void DoInference(const cv::Mat &inputs, size_t batch_size, bool preprocess, std::string filename);
